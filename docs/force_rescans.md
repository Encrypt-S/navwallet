...
navwallet will not drop transaction history by itself, as this is something that
...
```
$ cd $GOPATH/src/github.com/aguycalled/navwallet/cmd/dropwtxmgr
$ go get
```
...
```
$ dropwtxmgr
Database path: /home/username/.navwallet/mainnet/wallet.db
Drop all navwallet transaction history? [y/N] y
...
```
$ dropwtxmgr --db ~/.navwallet/testnet/wallet.db
Database path: /home/username/.navwallet/testnet/wallet.db
Drop all navwallet transaction history? [y/N] y
Dropping wtxmgr namespace
```

After dropping transaction history, navwallet may be restarted and a full rescan
