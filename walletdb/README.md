...
Package walletdb provides a namespaced database interface for navwallet.
...
[![GoDoc](https://godoc.org/github.com/aguycalled/navwallet/walletdb?status.png)]
(http://godoc.org/github.com/aguycalled/navwallet/walletdb)
...
http://localhost:6060/pkg/github.com/aguycalled/navwallet/walletdb

## Installation

```bash
$ go get github.com/aguycalled/navwallet/walletdb
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/aguycalled/navwallet/walletdb#example-package--BasicUsage)  
