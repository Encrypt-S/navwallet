...
[![GoDoc](https://godoc.org/github.com/navcoin/navwallet/walletdb?status.png)]
(http://godoc.org/github.com/navcoin/navwallet/walletdb)
...
http://localhost:6060/pkg/github.com/navcoin/navwallet/walletdb

## Installation

```bash
$ go get github.com/navcoin/navwallet/walletdb
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/navcoin/navwallet/walletdb#example-package--BasicUsage)  
